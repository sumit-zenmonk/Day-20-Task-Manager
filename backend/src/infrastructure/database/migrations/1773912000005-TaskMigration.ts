        ...
        await queryRunner.createTable(
            new Table({
                ...
                columns: [
                    ...
                    { name: "task_name", type: "varchar", isNullable: false, },
                    { name: "task_status", type: "tasks_task_status_enum", default: `'pending'`, isNullable: false, },
                    { name: "project_uuid", type: "uuid", isNullable: false, },
                    { name: "assigned_to", type: "uuid", isNullable: false, },
                    { name: "deadline", type: "timestamp", isNullable: false, },
